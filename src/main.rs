...
pub fn options_from_args() -> Options {
    let app = App::new(env!("CARGO_PKG_NAME"))
        ...
        .args_from_usage("-B, --blacklist-domains 'Treat list of specified domains as blacklist'")
        ...
        .args_from_usage("-n, --unwrap-noscript 'Replace NOSCRIPT elements with their contents'")
        .args_from_usage("-o, --output=[document.html] 'Write output to <file>, use - for STDOUT'")
    ...
    options.no_color = env::var_os(ENV_VAR_NO_COLOR).is_some() || atty::isnt(atty::Stream::Stderr);
...
fn main() {
    let mut options = options_from_args();
